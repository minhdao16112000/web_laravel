...
class CartController extends Controller
{
    ...
    public function gio_hang(Request $request){
        ...
        return view('frontend.cart.cart_ajax')->with('category',$cate_product)->with('material',$material_product)
        ->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)
        ->with('url_canonical',$url_canonical)->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)
    ...
    public function show_cart(Request $request){
        ...
        return view('frontend.cart.show_cart')->with('category',$cate_product)->with('material',$material_product)
        ->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)
        ->with('url_canonical',$url_canonical)->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)
        ->with('meta_title',$meta_title)->with('url_canonical',$url_canonical)->with('slider',$slider);
    }
