        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18">LIỆT KÊ SẢN PHẨM</h4>
                                        ...
                                        @foreach ($all_product as $key => $pro)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a onclick="return confirm('Bạn có chắc là muốn xóa sản phẩm này không?')"s href="{{URL::to('/delete-product/'.$pro->product_id)}}" class="active styling-edit" ui-toggle-class="">
