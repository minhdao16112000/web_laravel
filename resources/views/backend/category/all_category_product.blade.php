        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18">LIỆT KÊ DANH MỤC SẢN PHẨM</h4>
                                        ...
                                        @foreach ($all_category_product as $key => $cate_pro)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a onclick="return confirm('Bạn có chắc là muốn xóa danh mục này không?')"s href="{{URL::to('/delete-category-product/'.$cate_pro->category_id)}}" class="active styling-edit" ui-toggle-class="">
