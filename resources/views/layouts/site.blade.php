...
<head>
	...
	{{-- <meta property="og:site_name" content="http://localhost:81/a/public" />
...
<body>
				...
				<div class="row">
					...
					<div class="col-sm-5">
						...
						<div class="search_box pull-right">
							...
							<input type="submit" style="margin-top:0;color:#666" class="btn btn-primary btn-sm" name="search_iteams" value="Tìm kiếm"/>
						</div>
						</form>
					</div>
				</div>
						...
						<div class="carousel-inner">
                            ...
                            @foreach($slider as $key => $slide)
                                ...
                                <div class="item {{$i==1 ? 'active' : '' }}">
                                    ...
                                    <div class="col-sm-12">
                                        <img alt="{{$slide->slider_desc}}" src="{{asset('uploads/slider/'.$slide->slider_image)}}" height="400" width="900" {{-- class="img img-responsive" --}}>
			...
			<div class="row">
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="material_products"><!--brands_products-->
							<h2>Chất liệu sản phẩm</h2>
							<div class="material-name">
								<ul class="nav nav-pills nav-stacked">
									@foreach($material as $key => $material)
									<li><a href="{{ URL::to('/chat-lieu-san-pham/'.$material->material_id) }}"> <span class="pull-right"></span>{{ $material->material_name }}</a></li>
									@endforeach
								</ul>
							</div>
						</div><!--/brands_products-->
	...
	<div id="fb-root"></div>
	<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v9.0" nonce="mfVZBugR"></script>
